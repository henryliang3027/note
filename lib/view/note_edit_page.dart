  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        ...
        prefs.setInt('last_selected_note', -1);
                                ...
                                if (imageContent.imageType == ImageType.photo) {
                                  ...
                                  if (newimageContent != null) {
                                    ...
                                    if (newimageContent.path == '') {
                                      ...
                                      setState(() {
                                        int index = _imageContents
                                            .indexOf(imageContent);
                ...
                child: Row(
                  ...
                  children: [
                    RawMaterialButton(
                      ...
                      fillColor: Colors.transparent, //background color
                      onPressed: () async {
                        final XFile? res = await _imagePicker.pickImage(
                    ...
                    RawMaterialButton(
                      ...
                      onPressed: () async {
                        ...
                        if (res != null) {
                          String newFilePath =
                              await RepositoryProvider.of<FileRepository>(
                                      context)
                                  .copyToTemporaryDirectory(res.path);
